...
from webtest.model.WebInfoPreModel import WebInfoPre  # 请替换为你的ApiModule模型类
from datetime import datetime


# 模块信息
module_name = "WebInfoPre"  # 模块名称
module_model = WebInfoPre
...
def queryByPage():
    ...
    try:
        ...
        with application.app_context():
            ...
            results = []
            for data in datas:
                web_case_data = WebInfo.query.filter_by(id=data.pre_info_id).first()
                result = respModel().get_custom_attributes(web_case_data)
